...
sed -i.bu'2s/.*//' Makefile

sed -i.bu2 '3s/.*/CFLAGS= -I/Users/travis/tinyxml -pipe -fPIC -DVERSION=\"0.0.0\" -g -std=c++0x/' Makefile

sed -i.bu3 '4s/.*/LINKFLAGS=-L/Users/travis/tinyxml -lusb-1.0 -ltinyxml/' Makefile
