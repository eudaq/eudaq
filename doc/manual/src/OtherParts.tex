...
(or equivalent) function. Now it uses the \inline{std::this\_thread::sleep\_for} function provided by the C++ standard library. It takes as an argument the number of milliseconds to sleep.
