...
\myinputlisting[conf]{-30}{conf/ExampleConfig1.conf}
\newpage

\subsection{Example Producer}\label{sec:ExampleProducer}
\myinputlisting{-60}{main/exe/src/ExampleProducer.cxx}
\newpage

\subsection{Example DataConverterPlugin}\label{sec:ExampleConverter}
\myinputlisting{-90}{main/lib/plugins/ExampleConverterPlugin.cc}
\newpage
