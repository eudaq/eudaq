...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=0.6\textwidth]{images/RunControl}
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=\textwidth]{images/LogCollector}
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{images/RootMonitorConf}
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=0.8\textwidth]{images/RootMonitorPlots}
...
The \texttt{Correlator.exe} program is used to look for correlation between different sensor planes.
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{images/correl}
