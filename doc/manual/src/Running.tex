...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{src/images/RootMonitorConf}
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=0.8\textwidth]{src/images/RootMonitorPlots}
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{src/images/correl}
