...
void script_OldPowerSupply()
{
init_maps();
load_histos("run000290.raw.root", 4);
load_histos("run000291.raw.root", 5);
load_histos("run000292.raw.root", 6);
load_histos("run000293.raw.root", 7);
load_histos("run000294.raw.root", 8);
load_histos("run000295.raw.root", 9);
load_histos("run000296.raw.root",10);
load_histos("run000297.raw.root",11);
...
//////////////////////////////////////////////////////////////////////
TH1D* h_thr4=new TH1D("artem","old power supply",6*4+0, 0.5,6*4+0.5);
...
*/
 ...
 canvas->SaveAs("threshold-scan-old-power-supply.png");
 canvas->SaveAs("threshold-scan-old-power-supply.C");
