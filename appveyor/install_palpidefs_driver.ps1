function main(){
   ...
   If (Test-Path ("${env:APPVEYOR_BUILD_FOLDER}" + "\extern\alice-its-alpide-software-master-3189f00d7515733d46a61a5ab2606e436df4955b")) {
	...
	appveyor\download.ps1 -downloadLocation 'https://cernbox.cern.ch/index.php/s/QIRPTV84XziyQ3q/download' -storageLocation 'C:\\alice-its-alpide-software-master-latest.zip'; 
