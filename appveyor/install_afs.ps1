function main () {
	...
	Start-Process "C:\\openafs-en_US-64bit-1-7-3100.msi" -ArgumentList "/quiet /qn /norestart /log install_openafs.log ADDLOCAL=ALL InstallMode=Typical AFSCELLNAME=desy.de IAgree=yes" -Wait -verb runas;
