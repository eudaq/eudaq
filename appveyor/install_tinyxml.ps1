function main(){
   ...
   If (Test-Path ("${env:APPVEYOR_BUILD_FOLDER}" + "\extern\alice-its-alpide-software-master-3189f00d7515733d46a61a5ab2606e436df4955b")) {
	...
	C:\\projects\eudaq\appveyor\download.ps1 -downloadLocation 'http://downloads.sourceforge.net/project/tinyxml/tinyxml/2.6.2/tinyxml_2_6_2.zip' -storageLocation 'C:\\tinyxml_2_6_2.zipp'; 
