...
namespace eudaq{
  ...
  public:
    CaliceLCGenericObject(){_typeName = EVENT_TYPE;}
  ...
  LCCollectionVec* AHCalRawEvent2LCEventConverter::createCollectionVec(lcio::LCEvent &result, string colName, string dataDesc, time_t timestamp, int DAQquality ) const {
    LCCollectionVec *col = 0;
    try{
