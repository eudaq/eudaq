...
xterm -sb -sl 100000 -geometry 160x24 -T "ahcalbif TS datacollector" -e 'bin/euCliCollector -n CaliceAhcalBifBxidDataCollector -t ts1 ; read' &
...
# sleep 1
xterm -sb -sl 1000000 -geometry 160x24 -T "AHCAL" -e 'bin/euCliProducer -n AHCALProducer -t AHCAL1 -r tcp://$HOSTIP:$RCPOR|tee -a logs/ahcal.log && read || read'&
xterm -sb -sl 1000000 -geometry 160x24 -T "BIF" -e 'bin/euCliProducer -n caliceahcalbifProducer -t BIF1 -r tcp://$HOSTIP:$RCPOR|tee -a logs/ahcal.log && read || read'&
