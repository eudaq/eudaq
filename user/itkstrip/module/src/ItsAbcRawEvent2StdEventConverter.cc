...
std::string ItsAbcRawEvent2StdEventConverter::moduletype("SS");
uint32_t ItsAbcRawEvent2StdEventConverter::moduleid(30);
bool ItsAbcRawEvent2StdEventConverter::configured(0);
...
bool ItsAbcRawEvent2StdEventConverter::Converting(eudaq::EventSPC d1, eudaq::StdEventSP d2,
	...
	//if(!configured){
	moduletype = conf->Get("module", "none");
	moduleid = conf->Get("id", 99);
	configured=1;
	  //}
	...
	//std::cout << "super plane id: " << 19+AbcBlocks.getOffset() << std::endl;
	eudaq::StandardPlane superplane_module(moduleid, "ITS_ABC", "ABC");
	//std::cout << "looking at module " << moduletype << " id " << moduleid << std::endl;
						...
						if(channels[i]){
						  ...
						  //Write your own module type here:
							...
							if(moduletype == "R3Left"){
							  switch(strN){
							  case 0: superplane_module.PushPixel(128*7-1 - i, 1, 1);
							    break;
							  case 1: superplane_module.PushPixel(128*7-1 - i, 0, 1);
							    break;
							  case 4: superplane_module.PushPixel(i, 2, 1);
							    break;
							  case 5: superplane_module.PushPixel(i, 3, 1);
							    break;
							  }
							}
							if(moduletype == "R3Right"){
							  switch(strN){
							  case 2: superplane_module.PushPixel(128*7-1 - i, 1, 1);
							    break;
							  case 3: superplane_module.PushPixel(128*7-1 - i, 0, 1);
							    break;
							  case 6: superplane_module.PushPixel(i, 2, 1);
							    break;
							  case 7: superplane_module.PushPixel(i, 3, 1);
							    break;
							  }
							}
							...
							if(moduletype == "SS"){
							  switch(strN){
							  case 0: superplane_module.PushPixel(10*128-1 - i, 1, 1);
							    break;
							  case 1: superplane_module.PushPixel(10*128-1 - i, 0, 1);
							    break;
							  case 2: superplane_module.PushPixel(i, 2, 1);
							    break;
							  case 3: superplane_module.PushPixel(i, 3, 1);
							    break;
							  }
							}
							//Only for cern testbeam, SS+R1
							if(moduletype == "R1"){
							  switch(strN){
							  case 4: superplane_module.PushPixel(10*128 -1 - i, 1, 1);
							    break;
							  case 5: superplane_module.PushPixel(10*128 -1 - i, 0, 1);
							    break;
							  case 6: superplane_module.PushPixel(i, 2, 1);
							    break;
							  case 7: superplane_module.PushPixel(i, 3, 1);
							...
							//R5
							if(moduletype == "R5Left"){
							  switch(strN){
							  case 0: superplane_module.PushPixel(9*128-1-i, 1, 1);
							    break;
							  case 1: superplane_module.PushPixel(9*128-1-i, 0, 1);
							    break;
							  }
							}
							if(moduletype == "R5Right"){
                                                          switch(strN){
                                                          case 3: superplane_module.PushPixel(9*128-1-i, 0, 1);
							    break;
                                                          case 2: superplane_module.PushPixel(9*128-1-i, 1, 1);
							    break;
                                                          }
                                                        }
	...
	//d2->AddPlane(superplane30);
	//d2->AddPlane(superplane31);
	d2->AddPlane(superplane_module);
	return true;
}
