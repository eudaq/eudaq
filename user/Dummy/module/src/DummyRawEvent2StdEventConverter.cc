...
class DummyRawEvent2StdEventConverter: public eudaq::StdEventConverter{
public:
...
namespace{
  auto dummy0 = eudaq::Factory<eudaq::StdEventConverter>::
    Register<DummyRawEvent2StdEventConverter>(DummyRawEvent2StdEventConverter::m_id_factory);
}

bool DummyRawEvent2StdEventConverter::Converting(eudaq::EventSPC d1, eudaq::StdEventSP d2, eudaq::ConfigSPC conf) const{
