...
class Ex1RawEvent2TTreeEventConverter: public eudaq::TTreeEventConverter{
public:
...
namespace{
  auto dummy0 = eudaq::Factory<eudaq::TTreeEventConverter>::
    Register<Ex1RawEvent2TTreeEventConverter>(Ex1RawEvent2TTreeEventConverter::m_id_factory);
}

bool Ex1RawEvent2TTreeEventConverter::Converting(eudaq::EventSPC d1, eudaq::TTreeEventSP d2, eudaq::ConfigSPC conf) const{
