...
public:
  PALPIDEFSProducer(const std::string &name, const std::string &runcontrol,
      ...
      : eudaq::Producer(name, runcontrol), m_run(0), m_ev(0), m_done(false),
        ...
        m_full_config_v3(), m_ignore_trigger_ids(true), m_recover_outofsync(true),
        m_readout_mode(0), m_chip_type(0x0), m_strobe_length(0x0),
        m_strobeb_length(0x0), m_trigger_delay(0x0), m_readout_delay(0x0),
        m_monitor_PSU(false), m_back_bias_voltage(-1), m_dut_pos(-1.),
        m_SCS_charge_start(-1), m_SCS_charge_stop(-1), m_SCS_charge_step(-1),
        m_SCS_n_events(-1), m_SCS_n_mask_stages(-1), m_SCS_n_steps(-1),
        m_do_SCS(0x0), m_SCS_data(0x0), m_SCS_points(0x0) {}
