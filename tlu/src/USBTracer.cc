...
namespace tlu {
  ...
  public:
    ...
    void Write(const char * mode, unsigned long addr, const std::string & data, int status) {
  ...
  void dousbtrace(const char * mode, unsigned long addr, const std::string & data, int status) {
