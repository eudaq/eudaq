...
//!Simple Standard Plane Double Class
/*!
...
public:
  SimpleStandardPlaneDouble(const SimpleStandardPlane &p1,
                            const SimpleStandardPlane &p2)
      : _p1(p1), _p2(p2) {}
  std::string getName() const {
    char out[1024];
    sprintf(out, "%s%i_vs_%s%i", _p1.getName().c_str(), _p1.getID(),
            _p2.getName().c_str(), _p2.getID());
...
#endif // ifndef SIMPLESTANDARDPLANEDOUBLE_HH_
