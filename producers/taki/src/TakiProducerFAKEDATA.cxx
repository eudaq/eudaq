...
void TakiProducerFAKEDATA::send(const char* const p_c_buffer_TCP, const int& r_i_numBytes, const uint32_t long& r_ull_triggerID)
{
...
void TakiProducerFAKEDATA::sendCorrupt(const char* const p_c_buffer_TCP, const int& r_i_numBytes, const uint32_t long& r_ull_triggerID)
{
