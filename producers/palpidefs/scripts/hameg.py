...
def measure_all_print(sour):
    ...
    for c in range(4):
        ...
        sour.write("MEAS:VOLT?\n")
        voltage[c] = float(sour.readline())
    print "V1 (4DUTs)\tI1\t| V2 (3DUTs)\tI2\t| Vbb\t\tIbb\t| VbbControl\tIbbControl"
    print "%0.4fV\t\t%0.4fA\t| %0.4fV\t%0.4fA\t| %0.4fV\t%0.4fA\t| %0.4fV\t%0.4fA\n" % ( voltage[0], current[0], voltage[1], current[1], voltage[2], current[2], voltage[3], current[3])
