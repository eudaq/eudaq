...
namespace eudaq {
  ...
  int Mutex::Lock() { return pthread_mutex_lock(&m_impl->m_mutex); }

  int Mutex::TryLock() { return pthread_mutex_trylock(&m_impl->m_mutex); }

  int Mutex::UnLock() { return pthread_mutex_unlock(&m_impl->m_mutex); }
