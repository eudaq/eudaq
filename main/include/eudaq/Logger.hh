...
#define EUDAQ_LOG_STREAMOUT(level, msg, outStream, error_stream) ::eudaq::GetLogger().SendLogMessage(::eudaq::LogMessage(msg, ::eudaq::LogMessage::LVL_##level) \
    .SetLocation(__FILE__, __LINE__, EUDAQ_FUNC), outStream, error_stream)
