...
//#define TRIGGER_NUMBER_MASK				0x7FFFFF00 // trigger
//number
//#define EXT_TRIGGER_MODE_MASK			0x00000003 // trigger number
//#define TRIGGER_WORD_ERROR_MASK			0x000000FC // trigger
//number
//#define	L_TOTAL_TIME_OUT_MASK			0x00000004 // trigger
//number
//#define EOE_HIT_WORD_TIME_OUT_MASK		0x00000008 // trigger number
//#define EOE_WORD_WRONG_NUMBER_MASK		0x00000010 // trigger number
//#define UNKNOWN_WORD_MASK				0x00000020 // trigger
//number
//#define EOE_WORD_WARNING_MASK			0x00000040 // trigger number
//#define EOE_WORD_ERROR_MASK				0x00000080 // trigger
//number
//
...
//#define BCID_MACRO(X)			(((BCID_3_0_MASK & X) >> 21) |
//(BCID_7_4_MASK & X))
...
//#define TRIGGER_NUMBER_MACRO(X)			((TRIGGER_NUMBER_MASK & X) >>
//8)
//#define TRIGGER_MODE_MACRO(X)			(EXT_TRIGGER_MODE_MASK & X)
//#define TRIGGER_WORD_ERROR_MACRO(X)		((TRIGGER_WORD_ERROR_MASK & X)
//>> 2)
