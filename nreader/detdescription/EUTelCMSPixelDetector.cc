...
void EUTelCMSPixelDetector::setMode( string mode ) {
...
std::vector< EUTelROI > EUTelCMSPixelDetector::getSubChannels( bool withMarker ) const {
...
EUTelROI EUTelCMSPixelDetector::getSubChannelBoundary( size_t iChan, bool withMarker ) const {
