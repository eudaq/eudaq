...
std::vector<EUTelROI>
EUTelDEPFETDetector::getSubChannels(bool withMarker) const {
...
EUTelROI EUTelDEPFETDetector::getSubChannelBoundary(size_t iChan,
...
void EUTelDEPFETDetector::setMode(string mode) { _mode = mode; }
