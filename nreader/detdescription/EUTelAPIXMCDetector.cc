...
std::vector<EUTelROI>
EUTelAPIXMCDetector::getSubChannels(bool withMarker) const {
  if (withMarker)
...
EUTelROI EUTelAPIXMCDetector::getSubChannelBoundary(size_t iChan,
...
void EUTelAPIXMCDetector::setMode(string mode) { _mode = mode; }
