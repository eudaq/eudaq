...
#ifndef TakiProducer_H
#define TakiProducer_H

#include "eudaq/Producer.hh"

class TakiProducer : public eudaq::Producer
{

    public:
        TakiProducer(const std::string & name, const std::string & runcontrol);
