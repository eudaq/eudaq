...
################## OnlineMonitor ##################
xterm -r -sb -sl 100000 -geometry 200x40+300+750 -T "OnlineMon" -e 'bin/CMSHGCalMonitor  --monitor_name CMSHGCalMonitor --config_file user/cmshgcal/conf/onlinemon.conf --reduce 50 --reset -r tcp://$HOSTIP:$RCPORT |tee -a logs/mon.log ; read' &
