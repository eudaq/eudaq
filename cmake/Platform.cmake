...
if("cxx_std_14" IN_LIST CMAKE_CXX_COMPILE_FEATURES)
   SET(SUPPORT_STD_CXX14 true)
endif()
if("cxx_std_17" IN_LIST CMAKE_CXX_COMPILE_FEATURES)
   SET(SUPPORT_STD_CXX17 true)
endif()
if("cxx_std_20" IN_LIST CMAKE_CXX_COMPILE_FEATURES)
   SET(SUPPORT_STD_CXX20 true)
endif()
if("cxx_std_23" IN_LIST CMAKE_CXX_COMPILE_FEATURES)
   SET(SUPPORT_STD_CXX23 true)
endif()
...
if(${ROOT_FOUND})
  ...
  ELSEIF(ROOT_CXX_FLAGS MATCHES ".*c\\+\\+2[0].*")
    ...
    ENDIF()  
  ELSEIF(ROOT_CXX_FLAGS MATCHES ".*c\\+\\+1[7z].*")
    ...
    ENDIF()
  ELSEIF(ROOT_CXX_FLAGS MATCHES ".*c\\+\\+1[14y].*")
    SET(CMAKE_CXX_STANDARD 14)
  ELSEIF(ROOT_CXX_FLAGS MATCHES ".*c\\+\\+.*")
  ...
  IF(SUPPORT_STD_CXX23)
    set(CMAKE_CXX_STANDARD 23)
  ELSEIF(SUPPORT_STD_CXX20)
    set(CMAKE_CXX_STANDARD 20)      
  ELSEIF(SUPPORT_STD_CXX17)
    set(CMAKE_CXX_STANDARD 17)
